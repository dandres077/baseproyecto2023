                                    ...
                                    <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                                        ...
                                        <div class="col-xxl-6">
                                            ...
                                            <div class="card card-flush h-md-100">
                                                <!--begin::Body-->
                                                <div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0" style="background-position: 100% 50%; background-image:url('{{asset('assets/media/stock/900x600/42.png')}}')">
                                                    <!--begin::Wrapper-->
                                                    <div class="mb-10">
                                                        <!--begin::Title-->
                                                ...
                                                <div class="card-body py-9">
                                                    ...
                                                    <div class="row gx-9 h-100">
                                                        ...
                                                        <div class="col-sm-6 mb-10 mb-sm-0">
                                                            <!--begin::Image-->
                                                            <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-400px min-h-sm-100 h-100" style="background-size: 100% 100%;background-image:url('{{asset('assets/media/stock/600x600/img-65.jpg')}}')"></div>
                                                            <!--end::Image-->
                                                        </div>
                                                        <!--end::Col-->
                                                        <!--begin::Col-->
